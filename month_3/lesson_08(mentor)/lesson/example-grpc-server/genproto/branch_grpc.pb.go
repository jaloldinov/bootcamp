...
type BranchServiceClient interface {
	Create(ctx context.Context, in *CreateBranch, opts ...grpc.CallOption) (*CreateResponse, error)
}
...
func (c *branchServiceClient) Create(ctx context.Context, in *CreateBranch, opts ...grpc.CallOption) (*CreateResponse, error) {
...
type BranchServiceServer interface {
	Create(context.Context, *CreateBranch) (*CreateResponse, error)
...
func (UnimplementedBranchServiceServer) Create(context.Context, *CreateBranch) (*CreateResponse, error) {
