...
type StreamServiceClient interface {
	...
	Count(ctx context.Context, in *RequestStream, opts ...grpc.CallOption) (StreamService_CountClient, error)
...
func (c *streamServiceClient) Count(ctx context.Context, in *RequestStream, opts ...grpc.CallOption) (StreamService_CountClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/sale_service.StreamService/Count", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamServiceCountClient) Recv() (*ResponseStream, error) {
...
func (c *streamServiceClient) Sum(ctx context.Context, opts ...grpc.CallOption) (StreamService_SumClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[1], "/sale_service.StreamService/Sum", opts...)
	if err != nil {
		return nil, err
	}
...
type StreamService_SumClient interface {
	...
	CloseAndRecv() (*ResponseStream, error)
	grpc.ClientStream
}
...
func (x *streamServiceSumClient) Send(m *RequestStream) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceSumClient) CloseAndRecv() (*ResponseStream, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(ResponseStream)
...
func (c *streamServiceClient) Sqr(ctx context.Context, opts ...grpc.CallOption) (StreamService_SqrClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[2], "/sale_service.StreamService/Sqr", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamServiceSqrClient) Send(m *RequestStream) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceSqrClient) Recv() (*ResponseStream, error) {
	m := new(ResponseStream)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type StreamServiceServer interface {
	// server-side streaming
	Count(*RequestStream, StreamService_CountServer) error
	// client-side streaming
...
func (UnimplementedStreamServiceServer) Count(*RequestStream, StreamService_CountServer) error {
...
func (x *streamServiceCountServer) Send(m *ResponseStream) error {
...
type StreamService_SumServer interface {
	SendAndClose(*ResponseStream) error
...
func (x *streamServiceSumServer) SendAndClose(m *ResponseStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceSumServer) Recv() (*RequestStream, error) {
	m := new(RequestStream)
...
func (x *streamServiceSqrServer) Send(m *ResponseStream) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceSqrServer) Recv() (*RequestStream, error) {
	m := new(RequestStream)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sale_service.StreamService",
