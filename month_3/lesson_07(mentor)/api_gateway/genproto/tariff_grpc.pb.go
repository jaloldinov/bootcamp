...
type TariffServiceClient interface {
	...
	List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListTariffsResponse, error)
...
func (c *tariffServiceClient) CreateTariff(ctx context.Context, in *CreateTariffRequest, opts ...grpc.CallOption) (*CreateTariffResponse, error) {
	out := new(CreateTariffResponse)
	err := c.cc.Invoke(ctx, "/sale.TariffService/CreateTariff", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tariffServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListTariffsResponse, error) {
...
type TariffServiceServer interface {
	...
	List(context.Context, *ListRequest) (*ListTariffsResponse, error)
...
func (UnimplementedTariffServiceServer) CreateTariff(context.Context, *CreateTariffRequest) (*CreateTariffResponse, error) {
...
func (UnimplementedTariffServiceServer) List(context.Context, *ListRequest) (*ListTariffsResponse, error) {
...
func _TariffService_CreateTariff_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTariffRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TariffServiceServer).CreateTariff(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sale.TariffService/CreateTariff",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TariffServiceServer).CreateTariff(ctx, req.(*CreateTariffRequest))
	}
...
func _TariffService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TariffServiceServer).List(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TariffService_CreateTariff_Handler,
		},
		{
			MethodName: "Get",
