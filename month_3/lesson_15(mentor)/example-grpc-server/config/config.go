...
func Load() Config {
	...
	config.PersonServiceHost = cast.ToString(getOrReturnDefaultValue("PERSON_SERVICE_HOST", "localhost"))
	config.PersonServicePort = cast.ToString(getOrReturnDefaultValue("PERSON_SERVICE_PORT", "8000"))
