...
func main() {
	// datainserters.BranchDataInserter()
	// datainserters.UserDataInserter()
	// datainserters.CategoryDataInserter()
	// datainserters.ProductDataInserter()
	// datainserters.BranchProductDataInserter()
	// datainserters.TransactionDataInserter()
